...
const ProductDetail: React.FC<ProductDetailProps> = ({ productId, onBackToResults }) => {
  ...
  const handleWhatsAppClick = (company: any) => {
    ...
    const message = `Olá, vim através do site PartExplorer e gostaria de fazer uma cotação da peça ${sku}`;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            {/* Location Button */}
            <div className="mt-6">
              <button className="w-full bg-blue-600 hover:bg-blue-700 text-white px-4 py-3 rounded-lg flex items-center justify-center space-x-2">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-sm text-gray-600 mt-2 text-center">
                Para encontrar mais próximo de você
              </p>
            </div>
          </div>
                    ...
                    <div key={index} className="border border-green-200 rounded-lg p-4 bg-green-50">
                      ...
                      <div className="flex space-x-2">
                        ...
                        <button
                          ...
                          className="bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 px-4 py-2 rounded-lg flex items-center justify-center space-x-2"
                        >
